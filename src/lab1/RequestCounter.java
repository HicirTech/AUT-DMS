...
/**
   A servlet that demonstrates how session tracking can be used to
   count the number of requests made during a session.
   Note that the servlet requires some Java Enterprise edition API
